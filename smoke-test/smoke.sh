...
DATAHUB_TELEMETRY_ENABLED=false datahub docker quickstart --quickstart-compose-file ../docker/quickstart/docker-compose-without-neo4j.quickstart.yml --quickstart-compose-file ../docker/quickstart/docker-compose-without-neo4j.quickstart.ingestapi.yml --dump-logs-on-failure
